\begin{chapter}[theme/assets/background_negative]{peelilla}{Special Slides}
\begin{itemize}
    \item Chapter slides
...
\begin{itemize}
    ...
    \item There are seven ``official'' colours: \testcolor{maincolor}, \testcolor{peedarkgreen}, \testcolor{peegreen}, \testcolor{peelightgreen}, \testcolor{peered}, \testcolor{peeyellow}, \testcolor{peelilla}.
    \begin{itemize}
