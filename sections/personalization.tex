...
\begin{itemize}
    ...
    \verb|\footlinecolor{color}|
          \begin{itemize}
              ...
              \testcolor{maincolor}, \testcolor{peeyellow}, 
              \testcolor{peegreen}, \testcolor{peedarkgreen}
...
\end{verbatim}
\end{colorblock}
The ``official'' colours of colour blocks are: \testcolor{peelilla}, 
\testcolor{maincolor}, \testcolor{peedarkgreen}, and 
\testcolor{peeyellow}.
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}[<alert@2>]
  ...
  \testcolor{peegrey}
  \item Three shades of green: \testcolor{peelightgreen}, 
  \testcolor{peegreen}, \testcolor{peedarkgreen}
  \item Additional colours: \testcolor{peeyellow}, \testcolor{peered}, 
        \testcolor{peelilla}
  \end{itemize}
